...
// Copyright (c) 2014 The NewCoin developers
...
uint256 hashGenesisBlock("0xacd0f6d4c972121715665572d7167a0abfb77140ff393923f89cee7d09e3be75");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	if (nHeight == 1)
	{
        nSubsidy = 500000 * COIN; //first block premine less than 1%  0.8505%
		
	}
    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 175200); // Litecoin: 840k blocks in ~4 years NewCoin: 175.2k blocks ~ 1 year
    return nSubsidy + nFees;
}


static const int64 nTargetSpacing = 3 * 60; // Litecoin: 2.5 minutes ; NewCoin 3 minutes
static const int64 nOriginalInterval = 160; //160 blocks = 6 hrs
//static const int64 nTargetTimespan = 6 * 60 * 60; // Litecoin: 3.5 days ; NewCoin: 6 hours
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xacd0f6d4c972121715665572d7167a0abfb77140ff393923f89cee7d09e3be75");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "10/8/2014 '7th Heaven' star Sarah Goldberg found dead";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
